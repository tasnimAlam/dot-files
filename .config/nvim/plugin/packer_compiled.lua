...
vim.cmd [[au FileType jsx ++once lua require("packer.load")({'vim-javascript', 'vim-js-file-import', 'vim-jsx-pretty', 'nvim-ts-context-commentstring', 'vim-js'}, { ft = "jsx" }, _G.packer_plugins)]]
vim.cmd [[au FileType ts ++once lua require("packer.load")({'vim-javascript', 'vim-js-file-import', 'vim-jsx-pretty', 'nvim-ts-context-commentstring', 'vim-js'}, { ft = "ts" }, _G.packer_plugins)]]
vim.cmd [[au FileType rs ++once lua require("packer.load")({'rust.vim'}, { ft = "rs" }, _G.packer_plugins)]]
vim.cmd [[au FileType js ++once lua require("packer.load")({'vim-javascript', 'vim-js-file-import', 'vim-jsx-pretty', 'nvim-ts-context-commentstring', 'vim-js'}, { ft = "js" }, _G.packer_plugins)]]
vim.cmd [[au FileType tsx ++once lua require("packer.load")({'vim-javascript', 'vim-js-file-import', 'vim-jsx-pretty', 'nvim-ts-context-commentstring', 'vim-js'}, { ft = "tsx" }, _G.packer_plugins)]]
