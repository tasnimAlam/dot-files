...
vim.cmd [[au FileType tsx ++once lua require("packer.load")({'vim-jsx-pretty', 'nvim-ts-context-commentstring', 'vim-javascript', 'vim-js', 'vim-js-file-import'}, { ft = "tsx" }, _G.packer_plugins)]]
vim.cmd [[au FileType js ++once lua require("packer.load")({'vim-jsx-pretty', 'nvim-ts-context-commentstring', 'vim-javascript', 'vim-js', 'vim-js-file-import'}, { ft = "js" }, _G.packer_plugins)]]
vim.cmd [[au FileType jsx ++once lua require("packer.load")({'vim-jsx-pretty', 'nvim-ts-context-commentstring', 'vim-javascript', 'vim-js', 'vim-js-file-import'}, { ft = "jsx" }, _G.packer_plugins)]]
vim.cmd [[au FileType ts ++once lua require("packer.load")({'vim-jsx-pretty', 'nvim-ts-context-commentstring', 'vim-javascript', 'vim-js', 'vim-js-file-import'}, { ft = "ts" }, _G.packer_plugins)]]
