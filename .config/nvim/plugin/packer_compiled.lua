...
_G.packer_plugins = {
  ...
  ["vim-startify"] = {
    loaded = true,
    path = "/Users/tasnim/.local/share/nvim/site/pack/packer/start/vim-startify"
  },
  ["vim-surround"] = {
    loaded = true,
...
vim.cmd [[au FileType tsx ++once lua require("packer.load")({'vim-javascript', 'vim-js', 'vim-js-file-import', 'vim-jsx-pretty', 'nvim-treesitter-angular', 'nvim-ts-context-commentstring'}, { ft = "tsx" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType ts ++once lua require("packer.load")({'vim-javascript', 'vim-js', 'vim-js-file-import', 'vim-jsx-pretty', 'nvim-treesitter-angular', 'nvim-ts-context-commentstring'}, { ft = "ts" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-fugitive'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'hop.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
