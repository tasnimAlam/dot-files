...
vim.cmd [[au FileType jsx ++once lua require("packer.load")({'vim-jsx-pretty', 'vim-js-file-import', 'vim-js', 'nvim-ts-context-commentstring', 'vim-javascript'}, { ft = "jsx" }, _G.packer_plugins)]]
vim.cmd [[au FileType js ++once lua require("packer.load")({'vim-jsx-pretty', 'vim-js-file-import', 'vim-js', 'nvim-ts-context-commentstring', 'vim-javascript'}, { ft = "js" }, _G.packer_plugins)]]
vim.cmd [[au FileType ts ++once lua require("packer.load")({'vim-jsx-pretty', 'vim-js-file-import', 'vim-js', 'nvim-ts-context-commentstring', 'vim-javascript'}, { ft = "ts" }, _G.packer_plugins)]]
vim.cmd [[au FileType tsx ++once lua require("packer.load")({'vim-jsx-pretty', 'vim-js-file-import', 'vim-js', 'nvim-ts-context-commentstring', 'vim-javascript'}, { ft = "tsx" }, _G.packer_plugins)]]
