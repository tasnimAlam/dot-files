...
_G.packer_plugins = {
  ...
  ["calltree.nvim"] = {
    ...
    loaded = true,
    path = "/Users/tasnim/.local/share/nvim/site/pack/packer/start/calltree.nvim",
  ...
  ["cmp-vsnip"] = {
    after_files = { "/Users/tasnim/.local/share/nvim/site/pack/packer/opt/cmp-vsnip/after/plugin/cmp_vsnip.vim" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
    path = "/Users/tasnim/.local/share/nvim/site/pack/packer/opt/cmp-vsnip",
  ...
  harpoon = {
    loaded = true,
    path = "/Users/tasnim/.local/share/nvim/site/pack/packer/start/harpoon",
  ...
  ["nvim-hlslens"] = {
    loaded = true,
    path = "/Users/tasnim/.local/share/nvim/site/pack/packer/start/nvim-hlslens",
  ...
  ["nvim-treesitter-textsubjects"] = {
    loaded = true,
    path = "/Users/tasnim/.local/share/nvim/site/pack/packer/start/nvim-treesitter-textsubjects",
  ...
  ["sort.nvim"] = {
    loaded = true,
    path = "/Users/tasnim/.local/share/nvim/site/pack/packer/start/sort.nvim",
  ...
  ["vim-illuminate"] = {
    loaded = true,
    path = "/Users/tasnim/.local/share/nvim/site/pack/packer/start/vim-illuminate",
