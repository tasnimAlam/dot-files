...
pcall(vim.cmd, [[command -nargs=* -range -bang -complete=file GBranches lua require("packer.load")({'fzf-checkout.vim'}, { cmd = "GBranches", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]])
...
vim.cmd [[au FileType js ++once lua require("packer.load")({'vim-javascript', 'nvim-ts-context-commentstring', 'vim-js', 'vim-js-file-import', 'vim-jsx-pretty'}, { ft = "js" }, _G.packer_plugins)]]
vim.cmd [[au FileType ts ++once lua require("packer.load")({'vim-javascript', 'nvim-ts-context-commentstring', 'vim-js', 'vim-js-file-import', 'vim-jsx-pretty'}, { ft = "ts" }, _G.packer_plugins)]]
vim.cmd [[au FileType rs ++once lua require("packer.load")({'rust.vim'}, { ft = "rs" }, _G.packer_plugins)]]
vim.cmd [[au FileType jsx ++once lua require("packer.load")({'vim-javascript', 'nvim-ts-context-commentstring', 'vim-js', 'vim-js-file-import', 'vim-jsx-pretty'}, { ft = "jsx" }, _G.packer_plugins)]]
vim.cmd [[au FileType tsx ++once lua require("packer.load")({'vim-javascript', 'nvim-ts-context-commentstring', 'vim-js', 'vim-js-file-import', 'vim-jsx-pretty'}, { ft = "tsx" }, _G.packer_plugins)]]
