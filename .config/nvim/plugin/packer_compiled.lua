...
vim.cmd [[au FileType js ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'vim-javascript', 'vim-js', 'vim-jsx-pretty'}, { ft = "js" }, _G.packer_plugins)]]
vim.cmd [[au FileType ts ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'vim-javascript', 'vim-js', 'vim-jsx-pretty'}, { ft = "ts" }, _G.packer_plugins)]]
vim.cmd [[au FileType jsx ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'vim-javascript', 'vim-js', 'vim-jsx-pretty'}, { ft = "jsx" }, _G.packer_plugins)]]
vim.cmd [[au FileType tsx ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'vim-javascript', 'vim-js', 'vim-jsx-pretty'}, { ft = "tsx" }, _G.packer_plugins)]]
